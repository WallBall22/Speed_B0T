...
22-**Auto Role Code**
     ===========================================================
      React With ▶ To See Public Commands Codes`,
`:arrow_down: •••【 أكواد الأوامر العامة 】•••:arrow_down:
23-**كود مدة تشغيل البوت**   
24-**بينج البوت**
25-**كود معلومات السيرفر**
26-**كود كريديت**
27-**كود وضع الكلام اللي تبيه في صورة**
28-** كود راتب **
29-**كود تم دعوتك _بواسطة ..._**
30-**كود توب انفايت**
31-**كود اختصار روابط**
32-**كود البروفايل زي** `ProBot`
33-**كود User**
34-**كود الأفاتار**
35-**كود الاي دي**
...
===========================================================
	...
	`:arrow_down: •••【 أكواد أوامر الألعاب】•••:arrow_down:
37-**كود أسئلة فورتنايت**
38-**كود أسئلة كريتف ديستروكشن**
39-**كود أسرع كتابة**
40-**كود اكس اوو**
41-**كود فكك**
42-**كود عواصم**
...
46-**كود صراحة**
===========================================================`,`
     React With ▶ To See Music Commands Codes`]
	let page = 1;
...
client.on('message', message => {
        ...
        .setAuthor(` ${message.author.username} `, message.author.avatarURL)      
        .setTitle(`➡ Click Here `)
        .setURL(`https://discordapp.com/oauth2/authorize?client_id=535508658885492745&permissions=8&scope=bot`)
...
client.on('message', message => {
  ...
  .setAuthor(message.author.username)
  .setColor("#9B59B6")
  .addField(" ** :gear: Server Support :gear: **" , "  **https://discord.gg/JUCFmB2**")
